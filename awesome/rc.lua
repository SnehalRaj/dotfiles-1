...
widget_battery = require("conf.widgets.battery")
widget_brightness = require("conf.widgets.brightness")
widget_memory = require("conf.widgets.memory")
widget_volume = require("conf.widgets.volume")
...
clientkeys = gears.table.join(
    ...
    --awful.key({ modkey }, "less",        function (c) c:move_to_screen(c.screen.index+1) end,
              --{description = "move to next screen", group = "client"}),
    --awful.key({ modkey }, "more",        function (c) c:move_to_screen(c.screen.index-1) end,
